    ...
    companion object {
        ...
        fun firstPuzzle() {
            ...
            for (passwordInfo in passwords) {
                val split = passwordInfo.split("-", " ", ": ")
                val minCount = split[0].toInt()
                val maxCount = split[1].toInt()
                val letter: Char = split[2][0]
                val password = split[3]
                val letterCount = password.filter { it == letter }.count()

                if (letterCount in minCount..maxCount) {
                    validCount++
                }
            }
        ...
        fun secondPuzzle() {
            ...
            for (passwordInfo in passwords) {
                val split = passwordInfo.split("-", " ", ": ")
                val containsIndex = split[0].toInt()
                val notContainsIndex = split[1].toInt()
                val letter: Char = split[2][0]
                val password = split[3]

                if ((password[containsIndex - 1] == letter && password[notContainsIndex - 1] != letter)
                    || (password[containsIndex - 1] != letter && password[notContainsIndex - 1] == letter)) {
                    validCount++
                }
            }
            println("Result: $validCount")
